                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "40px" }}>
                    <div>
                        <div style={{ fontSize: "0.85rem", color: "#64748B", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "600" }}>
                            Account &gt; <span style={{ color: "#FF2E5B" }}>Payments</span>
                        </div>
                        <h1 style={{ fontSize: "2.5rem", fontWeight: "700", color: "#0F172A", margin: 0 }}>Payment Methods</h1>
                    </div>
                </div>
                ...
                <div className="account-layout">
                    ...
                    <div className="account-sidebar">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                            ...
                            <Link to="/payments" style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px 16px", borderRadius: "10px", backgroundColor: "#FFF0F3", color: "#FF2E5B", textDecoration: "none" }}>
                                <CreditCard size={18} />
                    ...
                    <div className="account-content">
                        <div style={{ backgroundColor: "#FFFFFF", borderRadius: "20px", boxShadow: "0 2px 10px rgba(0,0,0,0.02)", padding: "30px" }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                                <div>
                                    <h2 style={{ fontSize: "1.3rem", fontWeight: "700", color: "#0F172A", margin: "0 0 4px 0" }}>Saved Cards</h2>
                                    <p style={{ color: "#64748B", margin: 0, fontSize: "0.9rem" }}>Manage your saved payment methods for faster checkout.</p>
                                </div>
                                <button
                                    onClick={() => { }}
                                    style={{
                            ...
                            <div style={{ textAlign: "center", padding: "60px 20px", backgroundColor: "#F8F9FA", borderRadius: "16px", border: "1px dashed #CBD5E1" }}>
                                <CreditCard size={48} color="#94A3B8" style={{ marginBottom: "16px", opacity: 0.5 }} />
                                <h3 style={{ margin: "0 0 8px 0", color: "#0F172A", fontSize: "1.1rem" }}>No Payment Methods Found</h3>
