                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "40px" }}>
                    <div>
                        <div style={{ fontSize: "0.85rem", color: "var(--text-muted)", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "600" }}>
                            Account &gt; <span style={{ color: "var(--accent-primary)" }}>Addresses</span>
                        </div>
                        <h1 style={{ fontSize: "2.5rem", fontWeight: "700", color: "var(--text-primary)", margin: 0 }}>Saved Addresses</h1>
                    </div>
                </div>
                ...
                <div className="account-layout">
                    ...
                    <div className="account-sidebar">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                            ...
                            <Link to="/addresses" style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px 16px", borderRadius: "10px", backgroundColor: "var(--bg-secondary)", color: "var(--accent-primary)", textDecoration: "none" }}>
                                <MapPin size={18} />
                    ...
                    <div className="account-content">
                        <div style={{ backgroundColor: "var(--bg-main)", borderRadius: "20px", boxShadow: "0 2px 10px rgba(0,0,0,0.02)", padding: "30px" }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                                <div>
                                    <h2 style={{ fontSize: "1.3rem", fontWeight: "700", color: "var(--text-primary)", margin: "0 0 4px 0" }}>Default Address</h2>
                                    <p style={{ color: "var(--text-muted)", margin: 0, fontSize: "0.9rem" }}>This address is used for all your deliveries.</p>
                                </div>
                                <button
                            ...
                            {user?.address ? (
                                <div style={{ border: "1px solid var(--bg-tertiary)", borderRadius: "16px", padding: "24px", position: "relative" }}>
                                    <div style={{ position: "absolute", top: "24px", right: "24px", backgroundColor: "#ECFDF5", color: "var(--text-primary)", padding: "4px 12px", borderRadius: "50px", fontSize: "0.75rem", fontWeight: "700" }}>
                                        DEFAULT
                                    </div>
                                    <h3 style={{ margin: "0 0 12px 0", fontSize: "1.1rem", color: "var(--text-primary)" }}>{user?.name}</h3>
                                    <p style={{ margin: "0 0 6px 0", color: "var(--text-secondary)", lineHeight: "1.5" }}>{user?.address}</p>
                                    <p style={{ margin: "0 0 16px 0", color: "var(--text-secondary)" }}>
                                        {user?.city}, {user?.state} {user?.zipCode}
                                    </p>
                                    <p style={{ margin: 0, color: "var(--text-muted)", display: "flex", alignItems: "center", gap: "8px", fontSize: "0.9rem" }}>
                                        <span style={{ fontWeight: "600", color: "var(--text-primary)" }}>Phone:</span> {user?.phone || "Not provided"}
                                    </p>
                                </div>
                            ) : (
                                <div style={{ textAlign: "center", padding: "40px", backgroundColor: "var(--bg-secondary)", borderRadius: "16px" }}>
                                    ...
                                    <h3 style={{ margin: "0 0 8px 0", color: "var(--text-primary)" }}>No Address Saved</h3>
                                    <p style={{ color: "var(--text-muted)", marginBottom: "20px" }}>You haven't added a delivery address yet.</p>
                                    <button
                                        onClick={() => navigate("/profile")}
                                        style={{ backgroundColor: "var(--accent-primary)", color: "white", padding: "12px 24px", borderRadius: "50px", border: "none", fontWeight: "600", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "8px" }}
                                    >
